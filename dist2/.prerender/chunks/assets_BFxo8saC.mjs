import { $ as AstroError, C as InvalidImageService, H as RemoteImageNotAllowed, N as NoImageMetadata, X as UnsupportedImageConversion, Z as UnsupportedImageFormat, c as ExpectedImageOptions, k as MissingImageDimension, l as ExpectedNotESMImage, s as ExpectedImage, u as FailedToFetchRemoteImageDimensions, w as LocalImageUsedWrongly, y as IncompatibleDescriptorOptions } from "./errors-data_BVsUkJU2.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_BCHu5xun.mjs").catch((e) => {
