...
import { A as createAstro, O as unescapeHTML, S as addAttribute, b as maybeRenderHead, d as renderComponent, y as renderTemplate } from "./jsx-runtime_CXXmkpIb.mjs";
import { t as $$HeaderLink } from "./HeaderLink_Chqkg3BX.mjs";
...
var SITE_TITLE = "chiram";
var SITE_DESCRIPTION = "Trademark registration and brand protection services";
var SITE_AUTHOR = "chiram";
//#endregion
...
}, "C:/Users/zhu/chiram/src/components/BaseHead.astro", void 0);
//#endregion
...
}, "C:/Users/zhu/chiram/src/components/Footer.astro", void 0);
//#endregion
...
}, "C:/Users/zhu/chiram/src/components/Header.astro", void 0);
//#endregion
//#region src/components/SchemaOrg.astro
createAstro("https://chiram.cn");
var $$SchemaOrg = createComponent(($$result, $$props, $$slots) => {
	const Astro = $$result.createAstro($$props, $$slots);
	Astro.self = $$SchemaOrg;
	const { schema } = Astro.props;
	const json = JSON.stringify(schema);
	return renderTemplate`<script type="application/ld+json">${unescapeHTML(json)}<\/script>`;
}, "C:/Users/zhu/chiram/src/components/SchemaOrg.astro", void 0);
//#endregion
export { SITE_AUTHOR as a, $$BaseHead as i, $$Header as n, SITE_DESCRIPTION as o, $$Footer as r, SITE_TITLE as s, $$SchemaOrg as t };
